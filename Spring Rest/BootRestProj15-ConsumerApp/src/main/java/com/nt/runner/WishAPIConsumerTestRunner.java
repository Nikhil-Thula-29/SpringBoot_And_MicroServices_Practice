...
public class WishAPIConsumerTestRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		String baseUrl="http://localhost:8081/BootRestProj14-API-ProviderApp/wish-api/wish";
		//invoke the API Service/operation
		ResponseEntity<String> response=template.getForEntity(baseUrl, String.class);	//args-url,responsetype
		//show the results
