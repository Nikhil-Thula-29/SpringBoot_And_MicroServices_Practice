...
public class BootProj04RealtimeDiRealtimeStratergyDpApplication {
...
//	}
	...
	public static void main(String[] args) {
		ApplicationContext ctx=SpringApplication.run(BootProj04RealtimeDiRealtimeStratergyDpApplication.class, args);
