...
public class MySQLEmployeeDAOImpl implements IEmployeeDAO {
	...
	private static final String GET_EMPS_BY_DEGS="SELECT EMPNO,ENAME,JOB,SAL,DEPTNO FROM EMP_TABLE WHERE JOB IN(?,?,?) ORDER BY JOB";

	@Autowired
	private DataSource ds;
	
	public MySQLEmployeeDAOImpl() {
		System.out.println("Inside MySQL DAO");
	}
