...
public class BootProj11RealtimeDiSpringbootprofiles
{
	...
	public static void main(String[] args) {
		ApplicationContext ctx=SpringApplication.run(BootProj11RealtimeDiSpringbootprofiles.class, args);
							...
							//or this is giving profile in main method which is not recommended
		
//		SpringApplication app=new SpringApplication(BootProj11RealtimeDiSpringbootprofiles.class);
