...
public class BootProj15RealtimeDiRunners{
	...
	public static void main(String[] args) {
		SpringApplication.run(BootProj15RealtimeDiRunners.class,args);	//no extra code need to write everything in runners
